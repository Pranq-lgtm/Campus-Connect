...
import type { Announcement as _Announcement, Event as _Event, UserProfile as _UserProfile, UserRole as _UserRole, UserRole__1 as _UserRole__1, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async assignUserRole(arg0: Principal, arg1: UserRole__1): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.assignUserRole(arg0, to_candid_UserRole__1_n8(this._uploadFile, this._downloadFile, arg1));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async createAnnouncement(arg0: AnnouncementInput): Promise<bigint> {
        if (this.processError) {
            try {
    ...
    async createEvent(arg0: EventInput): Promise<bigint> {
        if (this.processError) {
            try {
    ...
    async getMyRole(): Promise<UserRole__1> {
        if (this.processError) {
            try {
    ...
    async listProfiles(): Promise<Array<[Principal, UserProfile]>> {
        if (this.processError) {
            try {
...
function from_candid_opt_n10(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_Announcement]): Announcement | null {
...
function from_candid_variant_n15(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "staff" in value ? UserRole.staff : "faculty" in value ? UserRole.faculty : "student" in value ? UserRole.student : value;
}
