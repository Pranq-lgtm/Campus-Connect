...
### *Empowering Peer-to-Peer Learning through GitHub Resource Synergy*

[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT)
[![Build Status](https://img.shields.io/badge/build-passing-brightgreen.svg)]()
[![Tech Stack](https://img.shields.io/badge/stack-MERN-blue.svg)]()
...
1.  **Clone the repository**
    ```bash
    git clone https://github.com/Pranq-lgtm/campus-connect.git
    cd campus-connect
    ```
...
---
*Created with ❤️ to empower the next generation of developers.*
